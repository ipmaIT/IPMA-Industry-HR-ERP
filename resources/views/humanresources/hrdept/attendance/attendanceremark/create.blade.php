...
<div class="container row align-items-start justify-content-center">
	...
	<div class="form-group row m-3 {{ $errors->has('attendance_remarks') ? 'has-error' : NULL }}">
		...
		<div class="col-md-8">
			<textarea name="attendance_remarks" id="ar" class="form-control form-control-sm" value="{{ old('attendance_remarks') }}" placeholder="Attendance Remarks (Remark Biasa Display Untuk Semua)"></textarea>
		</div>
	</div>
	...
	<div class="form-group row m-3 {{ $errors->has('hr_attendance_remarks') ? 'has-error' : NULL }}">
		...
		<div class="col-md-8">
			<textarea name="hr_attendance_remarks" id="hrar" class="form-control form-control-sm" value="{{ old('hr_attendance_remarks') }}" placeholder="HR Attendance Remarks (Remark HR Display Untuk HR, Admin Dan Director Sahaja)"></textarea>
		</div>
	</div>
	...
	<div class="form-group row m-3 {{ $errors->has('remarks') ? 'has-error' : NULL }}">
		...
		<div class="col-md-8">
			<textarea name="remarks" id="rem" class="form-control form-control-sm" value="{{ old('remarks') }}" placeholder="Remarks (Remark Database Boleh Biar Kosong Sahaja)"></textarea>
		</div>
	</div>
